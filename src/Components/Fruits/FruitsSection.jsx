...
export default function FruitsSection() {
  return (
    <div className="container ">
      <div className=" bg-[#f5eee9] w-full mb-20 px-1 py-3 flex lg:mx-12 justify-start lg:justify-center gap-4 items-center overflow-x-scroll scrollbar-hidden scroll-smooth   ">
        {FruitsSection3.map(({ id, heading, text, price, image }) => {
          return (
            <div key={id} className=" bg-white min-w-[250px] lg:w-[310px] min-h-[150px] lg:h-[235px]  ">
              <div className=" flex justify-between items-center px-4 ">
                <motion.div whileHover={{ scale: 1.1 }}>
                  <img src={image} alt="berries" className=" w-32 lg:w-48 h-32 lg:h-36 " />
                </motion.div>
                <motion.div whileHover={{ scale: 1.1 }}>
